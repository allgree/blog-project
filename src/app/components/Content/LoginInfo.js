        ...
        return (
            <div className="user_profile">
                ...
                <button className="button_custom button_edit_profile"
                        onClick={() => {this.props.trigger(this.props.state_param, this.props.state_value_form)}}>
                    Редактировать профиль
                </button>
                <br/>
                <button className=" button_custom button_edit_password"
                        onClick={() => {this.props.trigger(this.props.state_param, this.props.state_value_pass)}}>
                    Сменить пароль
                </button>
            </div>
        )
